...
public class StyleBuilderImpl implements StyleBuilder {
    ...
    private static final float scale_h1 = 1.90f;
    private static final float scale_h2 = 1.60f;
    private static final float scale_h3 = 1.4f;
    private static final float scale_h4 = 1.2f;
