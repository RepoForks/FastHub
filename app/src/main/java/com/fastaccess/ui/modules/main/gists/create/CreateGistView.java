...
public class CreateGistView extends BaseActivity<CreateGistMvp.View, CreateGistPresenter> implements CreateGistMvp.View {
    ...
    @BindView(R.id.createSecretGist) FontButton createSecretGist;
    @BindView(R.id.createPublicGist) FontButton createPublicGist;
    ...
    @Override public void onSetCode(@NonNull CharSequence charSequence) {
        ...
        MarkDownProvider.convertTextToMarkDown(fileContent, InputHelper.toString(charSequence));
    }
