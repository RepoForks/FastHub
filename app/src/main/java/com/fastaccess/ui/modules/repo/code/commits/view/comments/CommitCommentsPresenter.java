package com.fastaccess.ui.modules.repo.code.commits.view.comments;
...
public class CommitCommentsPresenter extends BasePresenter<CommitCommentsMvp.View> implements CommitCommentsMvp.Presenter {
    ...
    @Override public void onCallApi(int page, @Nullable String parameter) {
        ...
        if (page > lastPage || lastPage == 0) {
            sendToView(CommitCommentsMvp.View::onHideProgress);
            return;
        }
        setCurrentPage(page);
        manageSubscription(
                RxHelper.getObserver(RestClient.getCommitComments(login, repoId, sha, page))
                        .doOnSubscribe(() -> sendToView(CommitCommentsMvp.View::onShowProgress))
    ...
    @Override public void onFragmentCreated(@Nullable Bundle bundle) {
        ...
        sha = bundle.getString(BundleConstant.EXTRA2_ID);
    }
        ...
        if (bundle != null) {
            ...
            if (commId != 0) {
                manageSubscription(RxHelper.getObserver(RestClient.deleteIssueComment(login, repoId, commId))
                        .doOnSubscribe(() -> sendToView(CommitCommentsMvp.View::onShowProgressDialog))
