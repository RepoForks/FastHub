...
public class IssueCommentsPresenter extends BasePresenter<IssueCommentsMvp.View> implements IssueCommentsMvp.Presenter {
    ...
    @Override public void onCallApi(int page, @Nullable String parameter) {
        ...
        if (page > lastPage || lastPage == 0) {
            sendToView(IssueCommentsMvp.View::onHideProgress);
            return;
        }
        setCurrentPage(page);
        manageSubscription(
