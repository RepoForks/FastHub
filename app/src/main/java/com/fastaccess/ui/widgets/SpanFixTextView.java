...
public class SpanFixTextView extends FontTextView {
    ...
    private static final String TAG = SpanFixTextView.class.getSimpleName();

    public SpanFixTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SpanFixTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    /**
     * @return false because FU Android
     */
    ...
    @SuppressLint("WrongCall") private void setTextAndMeasure(CharSequence text, int widthMeasureSpec, int heightMeasureSpec) {
        setText(text);
        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
    }
