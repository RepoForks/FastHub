...
public class DrawShadowFrameLayout extends FrameLayout {
    ...
    public DrawShadowFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setShadowDrawable(mShadowDrawable);
    ...
    private void setShadowDrawable(Drawable drawable) {
    ...
    private static Property<DrawShadowFrameLayout, Float> SHADOW_ALPHA =
            new Property<DrawShadowFrameLayout, Float>(Float.class, "shadowAlpha") {
                @Override public Float get(DrawShadowFrameLayout dsfl) {
                    return dsfl.mAlpha;
                }

                @Override public void set(DrawShadowFrameLayout dsfl, Float value) {
                    dsfl.mAlpha = value;
