...
public class FilesViewHolder extends BaseViewHolder<FilesListModel> {
    ...
    private FilesViewHolder(@NonNull View itemView, FilesAdapter adapter) {
        super(itemView, adapter);

    }

    public static FilesViewHolder newInstance(@NonNull ViewGroup parent, FilesAdapter adapter) {
        return new FilesViewHolder(getView(parent, R.layout.files_row_item), adapter);
    }
