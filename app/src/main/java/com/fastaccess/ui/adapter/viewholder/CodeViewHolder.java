...
public class CodeViewHolder extends BaseViewHolder<SearchCodeModel> {
    ...
    public static CodeViewHolder newInstance(ViewGroup viewGroup, BaseRecyclerAdapter adapter) {
        return new CodeViewHolder(getView(viewGroup, R.layout.issue_row_item), adapter);
    }
