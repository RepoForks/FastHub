...
public interface UserRestService {
    ...
    Observable<Response<AccessTokenModel>> getAccessToken(@NonNull @Field("code") String code,
    ...
    @GET("user") Observable<Response<UserModel>> getUser();

    @GET("users/{username}") Observable<Response<UserModel>> getUser(@Path("username") @NonNull String username);
